 ...
 *
 *        Version:  1.0
 *        Created:  04/17/2018 09:36:59 AM
 *       Revision:  none
...
int main() {
    ...
    InventoryItem* newItem = NULL; //nullptr;      // Pointer used to create an item
    InventoryItem* tmp = NULL; //nullptr;          // Pointer used to lookup an item
